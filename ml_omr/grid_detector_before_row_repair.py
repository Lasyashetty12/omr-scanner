...
MAX_DIRECT_PIN_DY = 13.0
MAX_FINAL_DX_FROM_INPUT = 8.0
MAX_FINAL_DY_FROM_INPUT = 13.0
...
def fit_response_grid(
    ...
    for column_index in range(
        ...
        # when the detected center is close in BOTH x and y. This prevents
        # the last row from snapping to the signature/border line below it.
        direct_match = {}
