...
from ml_omr.local_warp import (
    build_local_warp_model,
    apply_local_warp,
    draw_local_warp_debug,
)
...
def scan_answers(
    ...
    # --------------------------------------------------------
    # LOCAL NON-LINEAR MOBILE-PHOTO WARP
    # --------------------------------------------------------
    local_warp_model = (
        build_local_warp_model(
            gray,
    ...
    raw_answers, ml_debug = (
        scan_answers_ml(
            gray=gray,
            coordinates=locally_warped_coordinates,
            crop_radius=int(
                template.get(
                    "ml_crop_radius",
                    16,
