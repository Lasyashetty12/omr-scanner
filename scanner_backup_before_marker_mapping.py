...
def get_best_fill_ratio_near(
    ...
    """
    Search a few pixels around the exact JSON coordinate.

    Keeps the JSON calibration unchanged while tolerating
    small camera/perspective alignment errors.
    """
...
def process_omr(
    ...
    # ========================================================
    # STEP 2:
    # FIND THE ACTUAL OUTER PAPER CORNERS INSIDE THE CROP.
    #
    # DO NOT map registration-marker centres to canvas edges:
    # that was the reason corrected_omr.jpg looked cut/halved.
    # ========================================================

    page_corners = (
        detect_page_corners_from_crop(
            cropped_image,
            template,
        )
    )
    ...
    # ========================================================
    # STEP 3:
    # WARP THE OUTER PAPER TO THE EXACT JSON TEMPLATE SIZE.
    # ========================================================
